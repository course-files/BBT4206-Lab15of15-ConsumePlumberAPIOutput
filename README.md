...
| **Recommended Citation (download [BibTex](RecommendedCitation.bib))** | Omondi, A. (2023). BBT4206-PHP-Lab15of15-ConsumePlumberAPIOutput [PHP]. https://github.com/course-files/BBT4206-PHP-Lab15of15-ConsumePlumberAPIOutput (Original work published 2023) |
...
-   *Lab14-ConsumePlumberAPIOutput.R*

-   [*Lab15-ConsumePlumberAPIOutput.php*](Lab15-ConsumePlumberAPIOutput.php)